...
import {
  GET_ALL_TERIMA_BARANG_PRODUKSI,
  setDataTerimaBarangProduksiSuccess,
  setDataTerimaBarangProduksiFailed,
} from "../actions/terimabarangproduksi";
import { setLoadingButton } from "../actions/ui";
import Moment from "moment";
import * as sweetalert from "../../infrastructure/shared/sweetalert";

const terimabahanproduksi =
  ...
  async (action) => {
    ...
    if (action.type === GET_ALL_TERIMA_BARANG_PRODUKSI) {
      ...
      if (data.date === null || data.kode_jenis_bahan === undefined) {
        ...
        writeLocal("terima_barang_produksi_head", data);
        ...
        if (response?.value !== null) {
          ...
          if (response?.value.length === 0) {
            ...
            dispatch(
              setDataTerimaBarangProduksiSuccess({ feedback: response?.value })
            );
          }
        } else {
          dispatch(setLoadingButton(false));
...
const data = [terimabahanproduksi];
