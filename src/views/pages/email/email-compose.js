          ...
          <div className="vertical-box">
            <div className="wrapper text-center">
              <div className="d-flex align-items-center justify-content-center">
                <button
                  onClick={this.toggleMobileEmailNav}
                  className="btn btn-inverse btn-sm mr-auto d-block d-lg-none"
                >
                  <i className="fa fa-cog"></i>
                </button>
                <Link
                  to="/email/compose"
                  className="btn btn-inverse p-l-40 p-r-40 btn-sm"
                >
                  Compose
                </Link>
              </div>
            ...
            <div
              className={
                "vertical-box-row collapse d-lg-table-row " +
                (this.state.isMobileEmailNavOn ? "show" : "")
              }
            >
                  ...
                  >
                    <div className="wrapper p-0">
                      ...
                      <ul className="nav nav-inbox">
                        <li>
                          <Link to="/email/inbox">
                            <i className="fa fa-inbox fa-fw m-r-5"></i> Inbox{" "}
                            <span className="badge pull-right">52</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/inbox">
                            <i className="fa fa-flag fa-fw m-r-5"></i> Important
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/inbox">
                            <i className="fa fa-envelope fa-fw m-r-5"></i> Sent
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/inbox">
                            <i className="fa fa-pencil-alt fa-fw m-r-5"></i>{" "}
                            Drafts
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/inbox">
                            <i className="fa fa-trash fa-fw m-r-5"></i> Trash
                          </Link>
                        </li>
                      </ul>
                      <div className="nav-title">
                      ...
                      <ul className="nav nav-inbox">
                        <li>
                          <Link to="/email/compose">
                            <i className="fa fa-fw f-s-10 m-r-5 fa-circle text-inverse"></i>{" "}
                            Admin
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/compose">
                            <i className="fa fa-fw f-s-10 m-r-5 fa-circle text-primary"></i>{" "}
                            Designer & Employer
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/compose">
                            <i className="fa fa-fw f-s-10 m-r-5 fa-circle text-success"></i>{" "}
                            Staff
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/compose">
                            <i className="fa fa-fw f-s-10 m-r-5 fa-circle text-warning"></i>{" "}
                            Sponsorer
                          </Link>
                        </li>
                        <li>
                          <Link to="/email/compose">
                            <i className="fa fa-fw f-s-10 m-r-5 fa-circle text-danger"></i>{" "}
                            Client
                          </Link>
                        </li>
                      </ul>
        ...
        <div className="vertical-box-column">
          <div className="vertical-box">
            <div className="wrapper">
              <span className="btn-group m-r-5">
                <Link to="/email/compose" className="btn btn-white btn-sm">
                  <i className="fa fa-envelope m-r-3 m-r-xs-0"></i>{" "}
                  <span className="hidden-xs">Send</span>
                </Link>
                <Link to="/email/compose" className="btn btn-white btn-sm">
                  <i className="fa fa-paperclip m-r-3 m-r-xs-0"></i>{" "}
              ...
              <span className="pull-right">
                <Link to="/email/compose" className="btn btn-white btn-sm">
                  <i className="fa fa-times m-r-3 m-r-xs-0"></i>{" "}
                  <span className="hidden-xs">Discard</span>
                </Link>
              </span>
            </div>
                    ...
                    <form action="/" method="POST" name="email_to_form">
                      <div className="email-to">
                        <span className="float-right-link">
                          {!this.state.cc && (
                            <Link
                              to="/email/compose"
                              onClick={this.handleCc.bind(this)}
                              className="m-r-5"
                            >
                              Cc
                            </Link>
                          ...
                          {!this.state.bcc && (
                            <Link
                              to="/email/compose"
                              onClick={this.handleBcc.bind(this)}
                            >
                              Bcc
                            </Link>
                          )}
                        ...
                        <div className="email-to">
                          ...
                          <div className="email-to-input">
                            <ReactTags
                              ...
                              suggestions={this.state.suggestions}
                              handleDelete={this.handleTagCcDelete.bind(this)}
                              handleAddition={this.handleTagCcAddition.bind(
                                this
                              )}
                            />
                          </div>
                        ...
                        <div className="email-to">
                          ...
                          <div className="email-to-input">
                            <ReactTags
                              classNames={this.state.tagClass}
                              placeholder=""
                              tags={this.state.tagsBcc}
                              suggestions={this.state.suggestions}
                              handleDelete={this.handleTagBccDelete.bind(this)}
                              handleAddition={this.handleTagBccAddition.bind(
                                this
                              )}
                            />
                          </div>
                      ...
                      <div className="email-content p-t-15">
                        <ReactQuill
                          ...
                          style={{
                            height: this.state.editor.height + "px",
                            marginBottom: "20px",
                          }}
                        />
                      </div>
            ...
            <div className="wrapper text-right">
              <button
                type="submit"
                className="btn btn-white p-l-40 p-r-40 m-r-5"
              >
                Discard
              </button>
              <button type="submit" className="btn btn-primary p-l-40 p-r-40">
                Send
              </button>
            </div>
          </div>
