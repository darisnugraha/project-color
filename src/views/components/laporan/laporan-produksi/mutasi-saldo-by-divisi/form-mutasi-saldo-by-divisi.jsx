...
const maptostate = (state) => {
  if (state.form.FormLaporanMutasiSaldoByDivisi?.values !== undefined) {
    return {
      initialValues: {
        date: state.form.FormLaporanMutasiSaldoByDivisi.values.date,
        divisi: state.form.FormLaporanMutasiSaldoByDivisi.values.divisi,
        bahan: state.form.FormLaporanMutasiSaldoByDivisi.values.bahan,
        jenis: state.form.FormLaporanMutasiSaldoByDivisi.values.jenis,
        user: state.form.FormLaporanMutasiSaldoByDivisi.values.user,
        no_job_order:
          state.form.FormLaporanMutasiSaldoByDivisi.values.no_job_order,
        alloy: state.form.FormLaporanMutasiSaldoByDivisi.values.alloy,
        reparasi: state.form.FormLaporanMutasiSaldoByDivisi.values.reparasi,
        all: state.form.FormLaporanMutasiSaldoByDivisi.values.all,
      },
    };
  } else {
    return {
...
let FormLaporanMutasiSaldoByDivisi = (prop) => {
      ...
      <Row>
        ...
        <Col offset={1}>
          <Button
            ...
            htmltype="button"
            loading={btnLoading}
            onClick={() => prop.dispatch(getAllMutasiSaldoByDivisi)}
            style={{ marginTop: 29 }}
          >
            Lihat Laporan
          </Button>
...
FormLaporanMutasiSaldoByDivisi = reduxForm({
  form: "FormLaporanMutasiSaldoByDivisi",
  enableReinitialize: true,
})(FormLaporanMutasiSaldoByDivisi);
export default connect(maptostate, null)(FormLaporanMutasiSaldoByDivisi);
