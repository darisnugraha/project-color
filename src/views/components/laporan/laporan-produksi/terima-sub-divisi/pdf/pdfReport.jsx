...
const pdfReport = (data = "") => {
  let data_head =
    JSON.parse(localStorage.getItem("terima_sub_divisi_head")) || [];
  ...
  let finalY = 30;
  doc.text(`Laporan TERIMA SUB DIVISI (${data_head.divisi})`, 14, 15);
  doc.setFontSize(20);
  doc.text("AMG", 200, 15);
