...
import {
  getAllKirimPusatByDivisi,
  setDataKirimPusatByDivisiSuccess,
} from "../../../../../application/actions/kirimpusatbydivisi";
...
const maptostate = (state) => {
  if (state.form.FormLaporanKirimPusatByDivisi?.values !== undefined) {
    return {
      initialValues: {
        date: state.form.FormLaporanKirimPusatByDivisi.values.date,
        divisi: state.form.FormLaporanKirimPusatByDivisi.values.divisi,
        kode_jenis_bahan:
          state.form.FormLaporanKirimPusatByDivisi.values.kode_jenis_bahan,
      },
    };
  } else {
    return {
...
let FormLaporanKirimPusatByDivisi = (prop) => {
      ...
      <Row>
        ...
        <Col offset={1}>
          <Field
            ...
            onBlur={(e) => e.preventDefault()}
            onChange={() =>
              prop.dispatch(setDataKirimPusatByDivisiSuccess({ feedback: [] }))
            }
          >
        ...
        <Col offset={1}>
          <Button
            ...
            htmltype="button"
            loading={btnLoading}
            onClick={() => prop.dispatch(getAllKirimPusatByDivisi)}
            style={{ marginTop: 29 }}
          >
            Lihat Laporan
          </Button>
...
FormLaporanKirimPusatByDivisi = reduxForm({
  form: "FormLaporanKirimPusatByDivisi",
  enableReinitialize: true,
})(FormLaporanKirimPusatByDivisi);
export default connect(maptostate, null)(FormLaporanKirimPusatByDivisi);
