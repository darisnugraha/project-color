...
const pdfReport = (data = "") => {
  let data_head = service.getLocal("mutasi_history_by_divisi_head") || [];
  ...
  let finalY = 30;
  doc.text(`Laporan MUTASI HISTORY BY DIVISI (${data_head.divisi})`, 14, 15);
  doc.setFontSize(20);
  doc.text("AMG", 200, 15);
  ...
  if (
    ...
    data_head.divisi === "FILLING" ||
    data_head.divisi === "POTONG SPRU"
  ) {
    tableColumn = [
      [
        {
  ...
  x.document.write(
    `<html>
    <head>
    <title>MUTASI HISTORY BY DIVISI</title>
    </head>
