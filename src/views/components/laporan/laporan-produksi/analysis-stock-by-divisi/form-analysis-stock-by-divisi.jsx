...
const maptostate = (state) => {
  if (state.form.FormLaporanAnalysisStock?.values !== undefined) {
    return {
      initialValues: {
        date: state.form.FormLaporanAnalysisStock.values.date,
        divisi: state.form.FormLaporanAnalysisStock.values.divisi,
        bahan: state.form.FormLaporanAnalysisStock.values.bahan,
        user: state.form.FormLaporanAnalysisStock.values.user,
        no_job_order: state.form.FormLaporanAnalysisStock.values.no_job_order,
        all: state.form.FormLaporanAnalysisStock.values.all,
      },
    };
  } else {
    return {
...
let FormLaporanAnalysisStock = (prop) => {
        ...
        <Col offset={1}>
          <Field
            ...
            onChange={(val) => {
              ...
              localStorage.removeItem("analysis_stock_by_divisi_head");
            }}
          >
            {datadivisi.map((item) => {
              return (
...
FormLaporanAnalysisStock = reduxForm({
  form: "FormLaporanAnalysisStock",
  enableReinitialize: true,
})(FormLaporanAnalysisStock);
export default connect(maptostate, null)(FormLaporanAnalysisStock);
