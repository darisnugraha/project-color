    ...
    return (
      <>
        <ReactHTMLTableToExcel
          ...
          table="table-to-xls"
          filename={`LAPORAN PO MASUK`}
          sheet={`LAPORAN PO MASUK`}
              ...
              return (
                <>
                  ...
                  {element.map((item) => {
                    return (
                      <tr>
                        <td colSpan={2}>{item.total_stock_awh75}</td>
                        <td>{item.total_berat_awh75}</td>
                        <td>{item.total_stock_ayl70}</td>
                        <td>{item.total_berat_ayl70}</td>
                        <td>{item.total_stock_ayl75}</td>
                        <td>{item.total_berat_ayl75}</td>
                        <td>{item.total_stock_eay18}</td>
                        <td>{item.total_berat_eay18}</td>
                        <td>{item.total_stock_eaw18}</td>
                        <td>{item.total_berat_eaw18}</td>
                      </tr>
                    );
                  })}
                  <tr>
                    ...
                    <td>
                      {element.reduce(
                        (a, b) => a + parseFloat(b.total_stock_awh75),
                        0
                      )}
                    </td>
                    <td>
                      {element
                        .reduce(
                          (a, b) => a + parseFloat(b.total_berat_awh75),
                          0
                        )
                        .toFixed(3)}
                    </td>
                    <td>
                      {element.reduce(
                        (a, b) => a + parseFloat(b.total_stock_ayl70),
                        0
                      )}
                    </td>
                    <td>
                      {element
                        .reduce(
                          (a, b) => a + parseFloat(b.total_berat_ayl70),
                          0
                        )
                        .toFixed(3)}
                    </td>
                    <td>
                      {element.reduce(
                        (a, b) => a + parseFloat(b.total_stock_ayl75),
                        0
                      )}
                    </td>
                    <td>
                      {element
                        .reduce(
                          (a, b) => a + parseFloat(b.total_berat_ayl75),
                          0
                        )
                        .toFixed(3)}
                    </td>
                    <td>
                      {element.reduce(
                        (a, b) => a + parseFloat(b.total_stock_eay18),
                        0
                      )}
                    </td>
                    <td>
                      {element
                        .reduce(
                          (a, b) => a + parseFloat(b.total_berat_eay18),
                          0
                        )
                        .toFixed(3)}
                    </td>
                    <td>
                      {element.reduce(
                        (a, b) => a + parseFloat(b.total_stock_eaw18),
                        0
                      )}
                    </td>
                    <td>
                      {element
                        .reduce(
                          (a, b) => a + parseFloat(b.total_berat_eaw18),
                          0
                        )
                        .toFixed(3)}
                    </td>
