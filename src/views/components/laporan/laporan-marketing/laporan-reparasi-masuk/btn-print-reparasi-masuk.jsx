...
const BtnPrint = () => {
  ...
  const dataReparasiMasuk = useSelector(ReparasiMasuk.getAllReparasiMasuk);
  const data = service.getLocal("reparasi_masuk") || [];

  const pdfExportHandle = () => {
    pdfReport(dataReparasiMasuk);
  };

  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport dataExel={dataReparasiMasuk} dataHead={data} />
      </Col>
