...
const BtnPrint = () => {
  ...
  const dataReparasiKeluar = useSelector(ReparasiKeluar.getAllReparasiKeluar);
  const data = service.getLocal("reparasi_keluar") || [];

  const pdfExportHandle = () => {
    pdfReport(dataReparasiKeluar);
  };

  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport dataExel={dataReparasiKeluar} dataHead={data} />
      </Col>
