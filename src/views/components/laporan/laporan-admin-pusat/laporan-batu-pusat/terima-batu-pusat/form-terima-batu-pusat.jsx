...
import { getAllAdminTerimaBatu } from "../../../../../../application/actions/adminterimabatu";
...
const maptostate = (state) => {
  if (state.form.FormLaporanTerimaBatuPusat?.values !== undefined) {
    return {
      initialValues: {
        date: state.form.FormLaporanTerimaBatuPusat.values.date,
        kode_jenis_bahan:
          state.form.FormLaporanTerimaBatuPusat.values.kode_jenis_bahan,
        batu: state.form.FormLaporanTerimaBatuPusat.values.batu,
        no_job_order: state.form.FormLaporanTerimaBatuPusat.values.no_job_order,
        alloy: state.form.FormLaporanTerimaBatuPusat.values.alloy,
      },
    };
  } else {
    return {
...
let FormLaporanTerimaBatuPusat = (prop) => {
      ...
      <Row>
        ...
        <Col offset={1}>
          <Button
            ...
            htmltype="button"
            loading={btnLoading}
            onClick={() => prop.dispatch(getAllAdminTerimaBatu)}
            style={{ marginTop: 29 }}
          >
            Lihat Laporan
          </Button>
...
FormLaporanTerimaBatuPusat = reduxForm({
  form: "FormLaporanTerimaBatuPusat",
  enableReinitialize: true,
})(FormLaporanTerimaBatuPusat);
export default connect(maptostate, null)(FormLaporanTerimaBatuPusat);
