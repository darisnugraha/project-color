...
const pdfReport = (data = "") => {
  let data_head = service.getLocal("admin_mutasi_stock_batu") || [];
  ...
  let finalY = 30;
  doc.text(`Laporan MUTASI STOCK BATU`, 14, 15);
  doc.setFontSize(20);
  doc.text("AMG", 200, 15);

  doc.setFontSize(10);
  doc.setProperties({
    title: `Laporan MUTASI STOCK BATU`,
  });
