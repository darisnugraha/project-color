...
const pdfReport = (data = "") => {
  ...
  let data_head = service.getLocal("admin_retur_batu");
  ...
  let finalY = 30;
  doc.text("Laporan ADMIN RETUR BATU", 14, 15);
  doc.setFontSize(20);
  doc.text("AMG", 200, 15);

  doc.setFontSize(10);
  doc.setProperties({
    title: "ADMIN RETUR BATU",
  });
  ...
  dataGroupArr.forEach((element) => {
    const rowKirim = [
      {
        content: "NO RETUR : " + element[0].no_retur,
        styles: {
          halign: "left",
          fillColor: "#bbbbbb",
        },
