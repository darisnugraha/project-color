...
import { getAllAdminKirimBatu } from "../../../../../../application/actions/adminkirimbatu";
...
const maptostate = (state) => {
  if (state.form.FormLaporanKirimBatuPusat?.values !== undefined) {
    return {
      initialValues: {
        date: state.form.FormLaporanKirimBatuPusat.values.date,
        kode_jenis_bahan:
          state.form.FormLaporanKirimBatuPusat.values.kode_jenis_bahan,
        batu: state.form.FormLaporanKirimBatuPusat.values.batu,
        no_job_order: state.form.FormLaporanKirimBatuPusat.values.no_job_order,
        alloy: state.form.FormLaporanKirimBatuPusat.values.alloy,
      },
    };
  } else {
    return {
...
let FormLaporanKirimBatuPusat = (prop) => {
      ...
      <Row>
        ...
        <Col offset={1}>
          <Button
            ...
            htmltype="button"
            loading={btnLoading}
            onClick={() => prop.dispatch(getAllAdminKirimBatu)}
            style={{ marginTop: 29 }}
          >
            Lihat Laporan
          </Button>
...
FormLaporanKirimBatuPusat = reduxForm({
  form: "FormLaporanKirimBatuPusat",
  enableReinitialize: true,
})(FormLaporanKirimBatuPusat);
export default connect(maptostate, null)(FormLaporanKirimBatuPusat);
