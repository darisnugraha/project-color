...
import { getAllKirimGudangQC } from "../../../../../application/actions/kirimgudangqc";
...
const maptostate = (state) => {
  if (state.form.FormLaporanKirimGudangQC?.values !== undefined) {
    return {
      initialValues: {
        date: state.form.FormLaporanKirimGudangQC.values.date,
        kode_jenis_bahan:
          state.form.FormLaporanKirimGudangQC.values.kode_jenis_bahan,
        design: state.form.FormLaporanKirimGudangQC.values.design,
        no_job_order: state.form.FormLaporanKirimGudangQC.values.no_job_order,
        alloy: state.form.FormLaporanKirimGudangQC.values.alloy,
      },
    };
  } else {
    return {
...
let FormLaporanKirimGudangQC = (prop) => {
      ...
      <Row>
        ...
        <Col offset={1}>
          <Button
            ...
            htmltype="button"
            loading={btnLoading}
            onClick={() => prop.dispatch(getAllKirimGudangQC)}
            style={{ marginTop: 29 }}
          >
            Lihat Laporan
          </Button>
...
FormLaporanKirimGudangQC = reduxForm({
  form: "FormLaporanKirimGudangQC",
  enableReinitialize: true,
})(FormLaporanKirimGudangQC);
export default connect(maptostate, null)(FormLaporanKirimGudangQC);
