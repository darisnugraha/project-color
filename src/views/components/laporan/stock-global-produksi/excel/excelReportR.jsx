...
class ExcelReportR extends Component {
  ...
  render() {
    ...
    const totalEay18Awal = this.props.dataExel.reduce(
      (a, b) => a + b.eay18_awal,
      0
    );
    const totalEay18In = this.props.dataExel.reduce(
      (a, b) => a + b.eay18_in,
      0
    );
    const totalEay18Out = this.props.dataExel.reduce(
      (a, b) => a + b.eay18_out,
      0
    );
    const totalEay18Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.eay18_sld,
      0
    );

    const totalEay14Awal = this.props.dataExel.reduce(
      (a, b) => a + b.eay14_awal,
      0
    );
    const totalEay14In = this.props.dataExel.reduce(
      (a, b) => a + b.eay14_in,
      0
    );
    const totalEay14Out = this.props.dataExel.reduce(
      (a, b) => a + b.eay14_out,
      0
    );
    const totalEay14Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.eay14_sld,
      0
    );

    const totalEay10Awal = this.props.dataExel.reduce(
      (a, b) => a + b.eay10_awal,
      0
    );
    const totalEay10In = this.props.dataExel.reduce(
      (a, b) => a + b.eay10_in,
      0
    );
    const totalEay10Out = this.props.dataExel.reduce(
      (a, b) => a + b.eay10_out,
      0
    );
    const totalEay10Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.eay10_sld,
      0
    );

    const totalEaw18Awal = this.props.dataExel.reduce(
      (a, b) => a + b.eaw18_awal,
      0
    );
    const totalEaw18In = this.props.dataExel.reduce(
      (a, b) => a + b.eaw18_in,
      0
    );
    const totalEaw18Out = this.props.dataExel.reduce(
      (a, b) => a + b.eaw18_out,
      0
    );
    const totalEaw18Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.eaw18_sld,
      0
    );

    const totalEaw14Awal = this.props.dataExel.reduce(
      (a, b) => a + b.eaw14_awal,
      0
    );
    const totalEaw14In = this.props.dataExel.reduce(
      (a, b) => a + b.eaw14_in,
      0
    );
    const totalEaw14Out = this.props.dataExel.reduce(
      (a, b) => a + b.eaw14_out,
      0
    );
    const totalEaw14Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.eaw14_sld,
      0
    );

    const totalEaw10Awal = this.props.dataExel.reduce(
      (a, b) => a + b.eaw10_awal,
      0
    );
    const totalEaw10In = this.props.dataExel.reduce(
      (a, b) => a + b.eaw10_in,
      0
    );
    const totalEaw10Out = this.props.dataExel.reduce(
      (a, b) => a + b.eaw10_out,
      0
    );
    const totalEaw10Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.eaw10_sld,
      0
    );
