...
class ExcelReport extends Component {
  ...
  render() {
    ...
    const totalAwh75Awal = this.props.dataExel.reduce(
      (a, b) => a + b.awh75_awal,
      0
    );
    const totalAwh75In = this.props.dataExel.reduce(
      (a, b) => a + b.awh75_in,
      0
    );
    const totalAwh75Out = this.props.dataExel.reduce(
      (a, b) => a + b.awh75_out,
      0
    );
    const totalAwh75Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.awh75_sld,
      0
    );

    const totalAyl70Awal = this.props.dataExel.reduce(
      (a, b) => a + b.ayl70_awal,
      0
    );
    const totalAyl70In = this.props.dataExel.reduce(
      (a, b) => a + b.ayl70_in,
      0
    );
    const totalAyl70Out = this.props.dataExel.reduce(
      (a, b) => a + b.ayl70_out,
      0
    );
    const totalAyl70Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.ayl70_sld,
      0
    );

    const totalAyl75Awal = this.props.dataExel.reduce(
      (a, b) => a + b.ayl75_awal,
      0
    );
    const totalAyl75In = this.props.dataExel.reduce(
      (a, b) => a + b.ayl75_in,
      0
    );
    const totalAyl75Out = this.props.dataExel.reduce(
      (a, b) => a + b.ayl75_out,
      0
    );
    const totalAyl75Saldo = this.props.dataExel.reduce(
      (a, b) => a + b.ayl75_sld,
      0
    );
